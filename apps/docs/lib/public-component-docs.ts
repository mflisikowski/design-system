...
const commonDependencies = ["@mflisikowski/tokens@0.5.0", "clsx@2.1.1"] as const;
...
export const publicComponentDocumentation = {
  ...
  dialog: component("dialog", ["@base-ui/react@1.8.0", "@mflisikowski/tokens@0.5.0", "clsx@2.1.1"]),
  toast: component("toast", ["@mflisikowski/tokens@0.5.0", "sonner@2.0.8"]),
  ...
  select: component("select", ["@base-ui/react@1.8.0", "@mflisikowski/tokens@0.5.0", "clsx@2.1.1"]),
